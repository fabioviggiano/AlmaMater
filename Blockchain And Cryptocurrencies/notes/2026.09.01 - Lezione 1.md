...
*Lezione introduttiva · Slide "Roadmap" e "What is this course all about?", incrociate con 01 – Preliminaries, 02 – Introduction Blockchain, 07.a – DHT short intro e 08 – Blockchain.*
...
#### 2.1.3 Tassonomia delle reti P2P
...
#### 2.1.4 Confronto quantitativo (slide *07.a*)
...
#### 2.1.5 Collegamento con la blockchain: la rete P2P di Bitcoin
...
#### 2.1.6 Sintesi: client/server vs P2P
...
> Nota: i riferimenti non presenti nelle slide, così come gli esempi storici Napster, Gnutella, Kazaa e Kademlia, vengono dalla letteratura generale. Titoli e anni vanno verificati prima di citarli.
